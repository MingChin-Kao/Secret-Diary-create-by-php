        ...
        if ($error != "") {
            ...
            if ($_POST['signUp'] == '1') {
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    //add here
                    //$vertificationCode = md5($_POST['password']);

                    $query = "INSERT INTO `diary` (`email`, `password`, `verificationCode` ) VALUES ('".mysqli_real_escape_string($link, $_POST['email'])."', '".mysqli_real_escape_string($link, $_POST['password'])."', '".random_int(10000, 99999)."')";
...
<form method="post" id = "logInForm">
    ...
    <fieldset class="form-group">
        ...
        <input class="btn btn-success" type="submit" name="forgotPassword" value="Forgot Password!">
